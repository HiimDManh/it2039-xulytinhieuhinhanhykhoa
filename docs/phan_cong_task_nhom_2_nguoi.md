...
Mục tiêu: làm bài có chiều sâu ứng dụng, không chỉ liệt kê guideline.
...
### Task N1 - Kiểm chứng guideline và nguồn

Mục tiêu: đảm bảo bài không nói sai ESC/EAS.

Cần làm:

- Tổng hợp các điểm dùng từ ESC/EAS 2019:
  - Phân tầng nguy cơ.
  - Mục tiêu LDL-C.
  - Điều trị bậc thang.
- Tổng hợp các điểm cập nhật 2025:
  - 2025 là Focused Update.
  - SCORE2/SCORE2-OP.
...
- 1 bảng "nội dung guideline -> slide dùng -> nguồn".

### Task N2 - Soạn phần phân tầng nguy cơ và mục tiêu LDL-C

Mục tiêu: giải thích vì sao case này không phải nguy cơ thấp dù chưa có triệu chứng.

Cần làm:

- Slide SCORE2/SCORE2-OP dùng khi nào.
- Slide khi nào SCORE2 không đủ.
- Slide nghi FH.
- Slide mục tiêu LDL-C theo nguy cơ.
- Slide áp mục tiêu vào case LDL-C 238 mg/dL.
...
Mục tiêu: làm rõ xử trí khi LDL-C giảm nhưng chưa đạt mục tiêu.
...
- [ ] Không khẳng định FH chắc chắn nếu chỉ là case nghi ngờ; dùng "nghi FH" hoặc "probable FH".

## 8. Quy ước review chéo

HiimDM review phần của Hoàng Nam theo 3 câu hỏi:

- Người nghe không chuyên sâu guideline có hiểu không?
- Nội dung có gắn lại với case không?
- Có quá nhiều thuật ngữ hoặc chữ không?

Hoàng Nam review phần của HiimDM theo 3 câu hỏi:
